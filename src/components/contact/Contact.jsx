...
const Contact = () => {
  return (
    <section className="contact section" id="contact">
        <h2 className="section__title"  style={{"padding-top":"50px"}}>Contact</h2>
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">thuanan24@gmail.com</span>
                    ...
                    <div className="contact__card">
                        <i className="uil uil-chat contact__card-icon"></i>
                        <h3 className="contact__card-title">Zalo</h3>
                        <span className="contact__card-data">+85913666652</span>
