   ...
   return (
    <div className="home__data">
        ...
        <div className='home__subtitle'>
          <p>Welcome from </p> 
          <div className="words">
            <span className='word'>a Developer</span>
            <span className='word'>a Researcher</span>
            <span className='word'>an Administrator</span>
          </div>
        </div>
        <p className="home__description">Lorem ipsum dolor sit amet. Aut porro voluptates id optio assumenda nam.</p>
